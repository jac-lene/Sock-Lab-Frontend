  ...
  return (
    <div> 
        ...
        <br/><br/>
            ...
            <h2>Leg</h2>
            <p>Join in MC and k1 rnd even in stockinetter, making the following increase or decrease according to your size: <br/>
            ...
            <p>K 2 more rnds in stockinette.</p>

            <h2>Heel Flap</h2>
            <p>K across the first 20 (24, 28, 32, 36, 40) sts. Break MC and join in CC3. Begin working your heel flap back and forth across the remaining 20 (24, 28, 32, 36, 40) sts as follows:</p><br/>
            <p>
                <b>Row 1:</b> K2, [sl1, k1] to end. Turn work.<br/>
                <b>Row 2:</b> Sl1, p to end. Turn work. <br/>
                <b>Row 3:</b> [Sl1, k1] to end. Turn work.<br/>
            </p>
            <p>Repeat rows 2 and 3 until heel flap measures 1.5 (1.75, 2, 2, 2.25, 2.5)"/4 (4.5, 5, 5.57, 6)cm. End after you have worked row 3. Break CC3.</p>

            <h2>Heel Turn</h2>
            <p>
                Join in CC4, then work the following:<br/>
                <b>Row 1:</b> Sl1, p 10 (12, 14, 16, 18, 20), p2tog, p1, turn.<br/>
                <b>Row 2:</b> Sl1, k3, ssk, k1, turn. <br/>
                <b>Row 3:</b> Sl1, p4, p2tog, p1, turn.<br/>
                <b>Row 4:</b> Sl1, k5, ssk, k1, turn.<br/>
            </p>
            <p>
                You have now established the following pattern for your heel turn: sl1, k or p to one stitch before the hap created by turning on the previous row, ssk or p2tog, k1 or p1, turn. Continue in this pattern until all your heel stitches have been worked. You should now have 13 (15, 17, 19, 21, 23) heel sts. Break CC4.
            </p>

            <h2>Gusset</h2>
            <p>Join in MC. With the right side of your work facing, pick up and k 10 (12, 14, 16, 18, 20) sts along the left side of your heel flap.</p>
            ...
            <h2>Toe Decreases</h2>
            <p>
                Break MC and join n CC5. K 1 rnd even, then begin the following decreases:<br/>
